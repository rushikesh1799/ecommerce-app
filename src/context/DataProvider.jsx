...
const initialState = {
    ...
    addresses: [
        {
            id: 1,
            address_line_1: "Plot No. 45",
            address_line_2: "Vivekananda Nagar No.2, Near Ganpati Mandir",
            city: "Manmad",
            state: "Maharashtra",
            pincode: "423104",
        },
        {
            id: 2,
            address_line_1: "Plot No. 11",
            address_line_2: "Rajesh Nagar, Near Surya Lawns",
            city: "Aurangabad",
            state: "Maharashtra",
            pincode: "431001",
        },
